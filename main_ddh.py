...
from rd_ctt.ddh import (
    ...
    RD_DDH_GUI_BOX_SIDE_BUTTON_TOP, RD_DDH_GUI_GRAPH_STATISTICS, RD_DDH_GUI_MODELS_UPDATE, RD_DDH_GUI_FINISHED
)
...
def main_ddh_gui():
    ...
    # see DDH GUI is ending too often
    # todo: test this
    k = RD_DDH_GUI_FINISHED
    if rv:
