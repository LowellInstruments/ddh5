...
DDH_NOTIFICATION_SYS_CANNOT_MOUNT_LI_PARTITION = 'system cannot mount LI partition'
DDH_NOTIFICATION_ERROR_API_CRASH = 'API just crashed'
...
DDH_ALL_NOTIFICATIONS = [
    ...
    DDH_NOTIFICATION_SYS_CANNOT_MOUNT_LI_PARTITION,
    DDH_NOTIFICATION_ERROR_API_CRASH
]
...
class _DDHNotification:
    def __init__(self, s, g, ln: LoggerNotification, ver, extra):
        ...
        self.msg_ver = ver
        self.reason = s
        self.ddh_box_name = ddh_config_get_vessel_name()
        self.ddh_box_sn = ddh_config_get_box_sn()
        self.ddh_box_project = ddh_config_get_box_project()
        self.ddh_platform = get_ddh_platform()
        self.ddh_sw_version = ddh_get_local_software_version()
        ...
        self.ddh_sw_commit = ddh_get_local_software_commit_id()
        self.ddh_has_lowell_loggers = ddh_config_contains_monitored_lowell_loggers()
    ...
    def to_file(self):
        ...
        fol = str(ddh_get_path_to_folder_sqs())
